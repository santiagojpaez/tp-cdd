...
- /home/santino/.config/opencode/skills
- /home/santino/.claude/skills
- /home/santino/.gemini/skills
- /home/santino/.gemini/antigravity/skills
...
### ai-sdk-5
- Path: /home/santino/.claude/skills/ai-sdk-5/SKILL.md
- Trigger: >
- Rules:
...
### branch-pr
- Path: /home/santino/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/santino/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/santino/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/santino/.config/opencode/skills/comment-writer/SKILL.md
...
### django-drf
- Path: /home/santino/.claude/skills/django-drf/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: /home/santino/.config/opencode/skills/go-testing/SKILL.md
...
### jira-epic
- Path: /home/santino/.claude/skills/jira-epic/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### jira-task
- Path: /home/santino/.claude/skills/jira-task/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### judgment-day
- Path: /home/santino/.config/opencode/skills/judgment-day/SKILL.md
...
### nextjs-15
- Path: /home/santino/.claude/skills/nextjs-15/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### playwright
- Path: /home/santino/.claude/skills/playwright/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### pytest
- Path: /home/santino/.claude/skills/pytest/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### react-19
- Path: /home/santino/.claude/skills/react-19/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /home/santino/.config/opencode/skills/skill-creator/SKILL.md
...
### tailwind-4
- Path: /home/santino/.claude/skills/tailwind-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### typescript
- Path: /home/santino/.claude/skills/typescript/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /home/santino/.config/opencode/skills/work-unit-commits/SKILL.md
...
### zod-4
- Path: /home/santino/.claude/skills/zod-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### zustand-5
- Path: /home/santino/.claude/skills/zustand-5/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
